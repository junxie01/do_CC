...
real t1,t2,dt
real sig2(nmax,3),signcc(nmax),sigpcc(nmax)
            ...
            do is2=2,nst       ! loop over station 2
               ...
               do ic1=1,3                     ! loop over com1
                  do ic2=1,3                  ! loop over com2
                     ...
                     write(output_ncc,'(1a,"/",1a,"_",1a,"/",1a,"_",1a,"_",1a,"_",1a,&
                     ...
                     call do_ncc(nsamp,npow,npt2,dt,sig1(:,ic1),sig2(:,ic2),signcc)
                     write(*,*) 'Ncc done!'
                     call write_ncf_sac(output_ncc,signcc,sachead1,sachead2,nsmpl,dt,1,nerr)
