         ...
         do is1=1,nst-1                  ! loop over station 1
            ...
            do is2=2,nst       ! loop over station 2
               ...
               if(dorot.eq.1)then
                  ...
                  do ic1=1,3
                     do ic2=1,3
                        call write_ncf_sac(output_ncc(ic1,ic2),sigrot(:,ic1,ic2),sachead1,sachead2,nsmpl,1,nerr)
                     enddo
                  enddo
               else
                  do ic1=1,3
                     do ic2=1,3
                        call write_ncf_sac(output_ncc(ic1,ic2),signcc(:,ic1,ic2),sachead1,sachead2,nsmpl,1,nerr)
                     enddo
                  enddo
               endif
